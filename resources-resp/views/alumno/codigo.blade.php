					...
					<div class="row">
						...
						<div class="col-lg-3 mb-3">
							...
							<div class="feature-box  fbox-effect">
								<div class="fbox-icon">
									<a href="{{route('alumno.pdf.evaluacion',["slug" => $evaluacion->slug])}}" target="_blank"><i class="icon-file-pdf1"></i></a>
								</div><br>
								<a href="{{route('alumno.pdf.evaluacion',["slug" => $evaluacion->slug])}}" target="_blank"><h3>Generar PDF</h3></a>
							</div>
							<br>
							<div class="feature-box  fbox-effect">
								<div class="fbox-icon">
									<a href="#" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="icon-email3"></i></a>
								</div><br>
								<a href="#" data-toggle="modal" data-target=".bs-example-modal-lg"><h5>Enviar a correo electronico</h5></a>
							</div>
							@if($correo != 1)
								<br>
								<h5 class="text-success"><i class="icon-ok"></i>Evaluación enviada al correo: <br>{{$correo}}</h5>
							@endif
