...
@section("titulo")
<title>{{$inscripcion->materia->materia->nombre}} | EVADOC</title>
@endsection

@section("titulo-pagina")
{{$inscripcion->evaluado->persona->nombre." ".$inscripcion->evaluado->persona->apellidos}}
@endsection
...
@section("url")
	...
	<li class="breadcrumb-item active" aria-current="page">{{$inscripcion->materia->materia->nombre}}</li>
@endsection
@section("contenido")
			...
			<div class="col-lg-12">
				...
				<form action="{{route("alumno.evaluar.evaluado")}}" method="post" name="form_cuestionario" id="form_cuestionario">
					...
					<?php
						...
						echo '
						<input type="hidden" value="Docente" name="tipo_evaluacion">
