...
@section("titulo")
<title>ACTIVIDAD | EVADOC</title>
@endsection

@section("titulo-pagina")
	{{$inscripcion->actividad->entrenador->persona->nombre." ".$inscripcion->actividad->entrenador->persona->apellidos}}
@endsection
			...
			<div class="col-lg-12">
				...
				<form action="{{route("alumno.evaluar.evaluado")}}" method="post" name="form_cuestionario" id="form_cuestionario">
					...
					<?php
						...
						echo '
						<input type="hidden" value="Actividad" name="tipo_evaluacion">
