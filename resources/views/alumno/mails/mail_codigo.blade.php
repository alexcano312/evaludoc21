...
<div id="wrapper" class="clearfix">
	...
	<header id="header">
		...
		<div id="header-wrap">
			...
			<div class="container clearfix">
				...
				<center>
				<div id="logo">
					<a href="" class="retina-logo" data-dark-logo="http://189.254.6.230/upt/SIG/assets/img/logo.png"><img src="http://189.254.6.230/upt/SIG/assets/img/logo.png" alt="Upt Logo"></a>
				</div><!-- #logo end -->
				</center>
	...
	<center>
		<img src="http://189.254.6.230/upt/eva_doc/images/logos_carreras.png" style="width: 85%; height: 50%;">
	</center>
