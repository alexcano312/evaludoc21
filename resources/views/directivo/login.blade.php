...
@section("titulohead")
	Login - Evaluación Docente | Directivo
@endsection
@section("css")
@endsection
	...
	<div class="container clearfix">
		...
		<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="max-width: 550px;">
			...
			<div class="acc_content clearfix">
				<form id="login-form" method="post" action="{{route("directivo.verifica.credenciales")}}" name="login-form" class="nobottommargin">
					{{csrf_field()}}
					...
					<div class="col_full">
						...
						<input type="text" id="login-form-username" name="correo" class="form-control" required="" />
				...
				<a class="nav-link text-right" href="{{route("directivo.recuperar.password")}}">¿Olvidaste tu contraseña?</a>
			</div>			
		</div>
	</div>
</div>
