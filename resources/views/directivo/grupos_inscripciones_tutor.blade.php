...
@section("titulohead")
	Inscripción de Tutor a Grupo | Directivo
@endsection
@section("css")
								...
								<div class="modal-body">
									...
									<form style="max-width: 100rem;" action="{{route("generales.agregar.grupo.tutor")}}" method="post">
										...
										<div class="form-group">
											...
											<small id="emailHelp" class="form-text text-muted">Si no encuentras el tutor, preciona <a target="_blank" href="{{route("directivo.tutores")}}">aquí</a> para agregar una persona nueva.</small>
										...
										<div class="form-group">
											...
											<small id="emailHelp" class="form-text text-muted">Si no encuentras el grupo, preciona <a target="_blank" href="{{route("directivo.grupos")}}">aquí</a> para agregar una grupo nuevo.</small>
