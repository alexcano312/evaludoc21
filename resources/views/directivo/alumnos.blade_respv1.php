...
@section("contenido")
							...
							<tbody>
								@foreach($alumnos as $alumno)
									<tr>
										...
										<td>
											<center>
												<a href="" class="button button-mini button-rounded button-red eliminar-alumno" valor="{{$alumno->id}}"><i class="icon-trash2"></i>Eliminar</a>
											</center>
										</td>
									</tr>
								@endforeach
	...
	<input type="hidden" id="url-eliminar" value="{{route("directivo.eliminar.alumno")}}">
@endsection
...
@section("js")
	...
	<script>
		...
		$('.eliminar-alumno').click(function () {
			Swal.fire({
				title: '¿Estás seguro?',
				text: "Se eliminara todo los registros de evaluaciones del alumno",
				icon: 'warning',
