	...
	<div class="content-wrap">
		<div class="container clearfix">
			<div class="table-responsive">
				<a href="#" id="abrir-registro" class="button button-border button-rounded button-green color-naranja" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="icon-line-circle-plus"></i>Agregar Entrenador</a>
				<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-lg">
						<div class="modal-body">
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title" id="myModalLabel">Agregar Nuevo Entrenador</h4>
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
								</div>
								<div class="modal-body">
									<p>Agrega la siguiente información para agregar un entrenador nuevo</a>.</p>
									<form style="max-width: 100rem;" action="{{route("generales.agregar.entrenador")}}" method="post">
										{{csrf_field()}}
										...
										@endforeach
										<center>
											<button type="submit" class="button button-border button-rounded button-aqua"><i class="icon-inbox"></i>Agregar Entrenador</button>
										</center>
									</form>
								</div>
							</div>
				...
				<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
						@foreach($actividades as $actividad)
							<tr class="">
								<td>{{$loop->index + 1}}</td>
								<td>{{$actividad->entrenador->persona->nombre}} {{$actividad->entrenador->persona->apellidos}}</td>																							
								<td>{{$actividad->nombre}}</td>	
								<td>{{$actividad->entrenador->observaciones}}</td>
								@if($actividad->entrenador->estatus == 1)
									<td>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-body">
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>Edita la siguiente información del Entrenador</a>.</p>
...
@section("js")
	...
	<script>
		...
		$(document).ready(function() {
			...
			var ruta = "{{route('general.buscar.personal.administrador')}}?q=%QUERY%";
