	...
	<div class="content-wrap">
		<div class="container clearfix">
			<div class="table-responsive">
				<center><a href="#" class="button button-border button-rounded button-green color-naranja text-center" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="icon-line-circle-plus"></i>Agregar Actividad</a></center>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-body">
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>Agrega la siguiente información para agregar una actividad nueva </a>.</p>
									<form style="max-width: 100rem;" action="{{route("generales.agregar.actividad")}}" method="post">
										{{csrf_field()}}
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="nombre-actividad" name="nombreActividad" placeholder="Ingresa el nombre de la actividad" required="">
										</div>
										...
										<center>
											<button type="submit" class="button button-border button-rounded button-aqua"><i class="icon-inbox"></i>Agregar Actividad</button>
										</center>
									</form>
								</div>
							</div>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-body">
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>Edita la siguiente información de la actividad</a>.</p>
									<form style="max-width: 100rem;">
										<div class="form-group">
											<label for="nombre">Nombre</label>
											<input type="text" class="form-control" id="editar-nombre-actividad" name="nombreActividad" placeholder="Ingresa el nombre de la actividad." required="">
										</div>
										<div class="form-group">
											<label for="clave">Clave</label>
											<input type="text" class="form-control" id="editar-clave-actividad" name="claveActividad" placeholder="Ingresa la clave de la actividad" required="">
