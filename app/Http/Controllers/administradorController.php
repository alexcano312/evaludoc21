...
class administradorController extends Controller
{
    ...
    public function actualizarInformacionCompleta(Request $request){
        ...
        // -- Cambiar el estatus de todas las evaluaciónes pasadas
        ...
        // -- evaluación activa para migrar los grupos
        ...
        foreach ($grupos as $grupo) {
            ...
            if($grupo->cuatrimestre_id >= 1 & $grupo->cuatrimestre_id < 10){
                ...
                foreach ($inscripcionesGrupo as $inscripcion) {
                    ...
                    // -- Cambiar estatus de inscripción vieja
            ...
            // -- Eliminar códigos de evaluaciones pasadas
        ...
        // -- Cambiar a todos los alumnos activos a evaluación no realizada
